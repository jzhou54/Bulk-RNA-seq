...
cgmtfile <- paste0(MSigDBfoldername,"/c2.all.v7.1.entrez.gmt")  # Curated gene sets
c2gene <- read.gmt(cgmtfile)

ccpgmtfile <- paste0(MSigDBfoldername,"/c2.cp.v7.5.1.entrez.gmt")  # Curated Canonical Pathway gene sets
...
ogmtfile <- paste0(MSigDBfoldername,"/c5.all.v7.5.1.entrez.gmt")  # Ontology gene sets
o2gene <- read.gmt(ogmtfile)

ggmtfile <- paste0(MSigDBfoldername,"/c5.go.bp.v7.5.1.entrez.gmt")  # GO BP gene sets
g2gene <- read.gmt(ggmtfile)

oncgmtfile <- paste0(MSigDBfoldername, "c6.all.v7.5.1.entrez.gmt")  # oncogenic signature gene sets
onc2gene <- read.gmt(oncgmtfile)

immgmtfile <- paste0(MSigDBfoldername, "c7.all.v7.5.1.entrez.gmt")  # immunologic signature gene sets
imm2gene <- read.gmt(immgmtfile)
